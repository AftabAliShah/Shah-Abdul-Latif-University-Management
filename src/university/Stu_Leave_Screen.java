...
public class Stu_Leave_Screen extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Stu_Leave_Screen frame = new Stu_Leave_Screen();
	...
	public Stu_Leave_Screen() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Stu_Leave_Screen.class.getResource("/Images/uniLogo.png")));
		setTitle("Student Leaves");
		...
		backBtn.setIcon(new ImageIcon(Stu_Leave_Screen.class.getResource("/Images/backSmall.png")));
		...
		searchLabel.setIcon(new ImageIcon(Stu_Leave_Screen.class.getResource("/Images/search.png")));
		...
		JLabel lblHeading = new JLabel("STUDENTS LEAVE");
		...
		lblHeading.setBounds(243, 37, 199, 36);
		...
		btnDlt.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				Stu_Leave_Delete sld = new Stu_Leave_Delete();
				sld.setVisible(true);
			}
		});
		btnDlt.setIcon(new ImageIcon(Stu_Leave_Screen.class.getResource("/Images/delete.png")));
		...
		btnUpdate.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				setVisible(false);
				Stu_Leave_Update slu= new Stu_Leave_Update(comboID.getSelectedItem().toString());
				slu.setVisible(true);
			}
		});
		btnUpdate.setIcon(new ImageIcon(Stu_Leave_Screen.class.getResource("/Images/update.png")));
		...
		btnAdd.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			setVisible(false);
			Stu_Leave_Form slf= new Stu_Leave_Form();
			slf.setVisible(true);
			}
		});
		btnAdd.setIcon(new ImageIcon(Stu_Leave_Screen.class.getResource("/Images/add.png")));
	...
	private void printDataIntoTable() {
		try {
			String query = "select l_id as ID,Student,Department, Date,Duration,Batch from student_leave sl inner join student s on sl.roll_no = s.Roll_No;";
